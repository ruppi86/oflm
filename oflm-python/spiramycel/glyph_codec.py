...
class SpiramycelGlyphCodec:
    ...
    def _initialize_glyph_table(self) -> Dict[int, GlyphInfo]:
        ...
        network_glyphs = [
            ...
            GlyphInfo(0x05, "🌊15", "flood protection active", GlyphCategory.NETWORK, "rate_limit", "🌊"),
            ...
            GlyphInfo(0x0B, "🌙46", "night mode routing", GlyphCategory.NETWORK, "low_power_path", "🌙"),
            GlyphInfo(0x0C, "☀️58", "solar boost available", GlyphCategory.NETWORK, "high_power_path", "☀️"),
        ...
        energy_glyphs = [
            ...
            GlyphInfo(0x13, "☀️29", "solar charge available", GlyphCategory.ENERGY, "harvest_solar", "☀️"),
            GlyphInfo(0x14, "🌙61", "night mode activated", GlyphCategory.ENERGY, "sleep_mode", "🌙"),
            ...
            GlyphInfo(0x18, "⚡09", "power sharing", GlyphCategory.ENERGY, "distribute_energy", "⚡"),
            ...
            GlyphInfo(0x1C, "🌡️56", "temperature monitoring", GlyphCategory.ENERGY, "thermal_sensor", "🌡️"),
        ...
        health_glyphs = [
            ...
            GlyphInfo(0x27, "🌿21", "growth detected", GlyphCategory.HEALTH, "capacity_increase", "🌿"),
            GlyphInfo(0x28, "🍄43", "decomposition cycle", GlyphCategory.HEALTH, "resource_recycle", "🍄"),
            GlyphInfo(0x29, "🌱65", "regeneration phase", GlyphCategory.HEALTH, "tissue_repair", "🌱"),
            ...
            GlyphInfo(0x2D, "🌡️26", "fever response", GlyphCategory.HEALTH, "temperature_spike", "🌡️"),
        ...
        silence_glyphs = [
            ...
            GlyphInfo(0x39, "🌸", "cherry blossom", GlyphCategory.SILENCE, "ephemeral_beauty", "🌸"),
            GlyphInfo(0x3A, "🍃", "leaf rustle", GlyphCategory.SILENCE, "gentle_movement", "🍃"),
            GlyphInfo(0x3B, "🦋", "butterfly touch", GlyphCategory.SILENCE, "light_presence", "🦋"),
            GlyphInfo(0x3C, "🌊", "wave rhythm", GlyphCategory.SILENCE, "natural_cycle", "🌊"),
            GlyphInfo(0x3D, "🌅", "dawn emergence", GlyphCategory.SILENCE, "new_beginning", "🌅"),
            GlyphInfo(0x3E, "🌌", "cosmic silence", GlyphCategory.SILENCE, "vast_quiet", "🌌"),
